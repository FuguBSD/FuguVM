...
| D-04 | External programs are commands, never libraries: `qemu-system-aarch64`, `qemu-img`, `expect`, `telnet`, and `ssh`.                                            | A command isolates a large foreign codebase behind a small argument surface.               |
