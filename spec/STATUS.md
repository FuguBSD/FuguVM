...
| [GST-MIRROR](guests.md#gst-mirror)             | done  | —       | [Mirror.pm](../lib/App/FuguVM/Mirror.pm), [mirror.t](../t/fuguvm/mirror.t) (the fetch subtests hold the download path), [proxy.t](../t/fuguvm/proxy.t), [cli.t](../t/fuguvm/cli.t), [guest.t](../t/fuguvm/guest.t) (each build site passes its logger) |
